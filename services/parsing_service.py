...
async def get_content_wallapop(data: dict[str, str]) -> list[str]:
    ...
    driver.get(url)
    static_log.info('Request es.wallapop.com', **data)
...
async def get_content_milanuncios(data: dict[str, str]):
    ...
    driver.get(url)
    static_log.info('Request www.milanuncios.com', **data)
...
async def get_content_coches(data: dict[str, str]):
    ...
    driver.get(url)
    static_log.info('Request www.coches.net', **data)
